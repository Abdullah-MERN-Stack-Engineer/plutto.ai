    ...
    <div ref={containerRef} className="h-screen relative">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
          {/* Top decorative line */}
          <div className="w-16 md:w-24 h-px bg-gradient-to-r from-transparent via-cyan-400 to-transparent mx-auto mb-8 md:mb-16"></div>
          ...
          {/* Side text elements */}
          <div className="absolute left-4 md:left-8 top-1/2 transform -translate-y-1/2 text-gray-600 text-xs md:text-sm max-w-xs hidden lg:block">
            <p>was seamless</p>
            <p>ctly what we</p>
            <p>d more.</p>
          </div>
          
          <div className="absolute right-4 md:right-8 top-1/2 transform -translate-y-1/2 text-gray-600 text-xs md:text-sm max-w-xs text-right hidden lg:block">
