...
const Header = ({ isDark = false }) => {
  ...
  return (
    <motion.header 
      className="fixed top-0 left-0 right-0 flex justify-between items-center p-6 z-50"
    ...
    <div className="flex items-center space-x-6">
      <div className="flex flex-col space-y-1">
        <motion.div className="w-6 h-[2px]" style={{ backgroundColor: textColor }}></motion.div>
        <motion.div className="w-6 h-[2px]" style={{ backgroundColor: textColor }}></motion.div>
        <motion.div className="w-6 h-[2px]" style={{ backgroundColor: textColor }}></motion.div>
      </div>
    </div>
